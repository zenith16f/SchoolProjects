...
Each folder corresponds to a subject, and contains one or more projects developed for it.
...
- Projects may have their own `README.md` with setup instructions and details.
